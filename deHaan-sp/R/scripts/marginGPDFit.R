...
createMarginScaleParameters <- function (file,var,above,r,cmax,files.scale.parameters,grid=TRUE,mode) {
  ...
  if (mode == 1 || mode == 2 || mode == 4) {
    ...
    print("margin.mode == 3, no need to fit margin parametric model")
  }
}
